  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-24 space-y-4 text-center">
        ...
        <p className="text-xs font-mono uppercase tracking-[0.35em] text-[#d1d5db]/80">Cargando reservaciones...</p>
      </div>
    )
  }
  ...
  if (!Array.isArray(reservations) || reservations.length === 0) {
    return (
      <div className="rounded-[2rem] border border-dashed border-[#f8fafc]/20 bg-black/20 px-6 py-16 text-center">
        <p className="text-lg font-bold text-[#f8fafc]">No hay reservaciones disponibles</p>
