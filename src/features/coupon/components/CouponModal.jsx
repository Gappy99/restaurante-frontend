    ...
    <form onSubmit={handleSubmit(onFormSubmit)} autoComplete="off" className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            autoComplete="off"
            className="w-full px-3 py-2 border border-[#B08851]/40 bg-[#FFFDF8] text-[#5B300E] placeholder:text-[#5B300E]/50 caret-[#5B300E] rounded-md focus:outline-none focus:border-[#5B300E] focus:ring-2 focus:ring-[#5B300E]/20"
        ...
        <div>
          ...
          <select
            ...
            autoComplete="off"
            className="w-full px-3 py-2 border border-[#B08851]/40 bg-[#FFFDF8] text-[#5B300E] caret-[#5B300E] rounded-md focus:outline-none focus:border-[#5B300E] focus:ring-2 focus:ring-[#5B300E]/20"
          >
        ...
        <div className="md:col-span-2">
          ...
          <select
            ...
            autoComplete="off"
            className="w-full rounded-md border border-[#B08851]/40 bg-[#FFF8F8] px-3 py-2 text-[#5B300E] focus:outline-none focus:border-[#5B300E] focus:ring-2 focus:ring-[#5B300E]/20"
          >
      ...
      <div className="flex justify-end gap-4 pt-6 border-t border-[#B08851]/20">
        <button
          type="button"
          onClick={onCancel}
          className="px-4 py-2 text-sm font-medium text-[#5B300E] bg-[#FEF5E5] border border-[#D4B27C] rounded-md hover:bg-[#FCE9C6] focus:outline-none"
        >
          Cancelar
        </button>
        <button
          type="submit"
          disabled={loading}
          className="px-4 py-2 text-sm font-medium text-white bg-[#5B300E] border border-transparent rounded-md hover:bg-[#4C2E0C] disabled:opacity-50"
        >
